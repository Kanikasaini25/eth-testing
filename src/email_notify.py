    ...
    *,
    ...
    body = "\n".join(
        [
            ...
            f"Risk (initial): {risk:.2f}",
            f"Target +2%:  {target_1:.2f} (keep initial SL)",
            f"Target +3%:  {target_2:.2f} (move SL to +2%)",
            f"Target +4%:  {target_3:.2f} (move SL to +3%)",
            f"Target +5%:  {target_4:.2f} (close all)",
