...
def params_from_rule(parameters: dict) -> PocBacktestParams:
    return PocBacktestParams(
...
def _summarize(trades: list[dict], starting_wallet: float) -> PocBacktestResult:
...
def _open_from_signal(signal, row: dict, params: PocBacktestParams, wallet: float) -> OpenPosition | None:
...
def run_poc_backtest(m15_rows: list[dict], params: PocBacktestParams | None = None) -> PocBacktestResult:
    params = params or PocBacktestParams()
...
def run_m15_backtest(m15_rows: list[dict], _m1_rows=None, params: PocBacktestParams | None = None):
    return run_poc_backtest(m15_rows, params)


def result_to_dict(result: PocBacktestResult) -> dict:
