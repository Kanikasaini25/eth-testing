#!/usr/bin/env python3
"""
30M Swing Break + 5M Retest backtest runner.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Backtest 30M Swing Break + 5M Retest on Delta Exchange data."
    )
    parser.add_argument(
        "--symbol",
...
def main() -> int:
    ...
    print(
        f"  Result: {result.verdict} | breaks={result.breaks_detected}, "
        f"entries={result.retest_entries}, trades={result.total_trades}, "
